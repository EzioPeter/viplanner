...
class ReconstructionCfg:
    ...
    # environment name
    env: str = "town01"  # Vvot9Ly1tCj ur6pFq6Qu1A B6ByNegPMKs 2azQ1b91cZZ 2n8kARJN3HM JeFG25nYj2p 
    # image suffix
    depth_suffix = "_cam0"
    sem_suffix = "_cam1"
    ...
    max_images: Optional[int] = 500  # maximum number of images to reconstruct, if None, all images are used
