...
if __name__ == "__main__":
    ...
    parser.add_argument("-bf", "--bag_file", help="Input ROS bag.",
                        default='/home/pascal/SemNav/env/anymal/2023_03_23_rsl/_2023-03-23-20-30-17.bag')  # '/home/pascal/SemNav/env/anymal/2023_03_27_eth_sun/mergedBag.bag')
    ...
    parser.add_argument("-d", "--debug", action="store_false", help="Visualize semantic prediction and debug information (assumes img of size 1080x1440)",
                        default=True)
