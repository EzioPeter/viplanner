...
class SegmentsCfg:
    ...
    def export_dir_path(self) -> str:
        return os.path.join(os.getenv('EXPERIMENT_DIRECTORY', "/home/pascal/viplanner/imperative_learning/"), "data", self.export_dir)
...
class Mask2FormerCfg:
    ...
    def config_file(self) -> str:
        return os.path.join(os.getenv('EXPERIMENT_DIRECTORY', "/home/pascal/viplanner/sem_seg"), "m2f_model", self.config)
    
    @property
    def model_file(self) -> str:
        return os.path.join(os.getenv('EXPERIMENT_DIRECTORY', "/home/pascal/viplanner/sem_seg"), "m2f_model", self.model)
    
    @property
    def coco_data_path(self) -> str:
        return os.path.join(os.getenv('EXPERIMENT_DIRECTORY', "/home/pascal/viplanner/imperative_learning"), "data", self.coco_data)

    @property
    def output_path(self) -> str:
        return os.path.join(os.getenv('EXPERIMENT_DIRECTORY', "/home/pascal/viplanner/sem_seg"), "m2f_model", self.output)
